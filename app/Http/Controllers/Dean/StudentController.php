...
use App\DataTables\Dean\StudentsDataTable;
...
class StudentController extends Controller
{
    ...
    {
        return $dataTable->render('dean.manage-student.index');
    }
    ...
    {
        return view('dean.manage-student.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('dean.manage-student.show', compact('student', 'userType', 'college', 'program'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dean.manage-student.edit', compact('student'));
    }
    ...
    public function verify(string $id)
    {
        ...
        return redirect()->route('dean.manage-student.index');
    }
