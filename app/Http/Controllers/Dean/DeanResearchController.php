...
use App\DataTables\Dean\DeanResearchDataTable;
use App\Http\Controllers\Controller;
use App\Models\Research;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class DeanResearchController extends Controller
{

    /**
     * Display a listing of the resource.
     */
    public function index(DeanResearchDataTable $dataTable)
    {
        return $dataTable->render('dean.manage-research.index');
    }
...
/*             dd($research);
 */        return view('dean.manage-research.show', compact('research'));
    }
