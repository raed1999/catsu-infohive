...
use App\DataTables\Admin\AdminResearchDataTable;
...
class AdminResearchController extends Controller
{
     ...
     */
    public function index(AdminResearchDataTable $dataTable)
    {
        return $dataTable->render('admin.manage-research.index');
    }
