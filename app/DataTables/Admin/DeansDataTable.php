...
class DeansDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('usertype_id', Role::DEAN)->with(['college'])->withTrashed()->select('faculties.*');
    }
    ...
    {
        return 'InfoHive_Deans_Information' . date('YmdHis');
    }
}
