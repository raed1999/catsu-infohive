            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Clerk Profile</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8">Dean</div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8">
                                                ...
                                                <form action="{{ (!$faculty->deleted_at) ? route('dean.manage-clerk.destroy',$faculty->id) : route('dean.manage-clerk.restore',$faculty->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
