                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8">
                                                ...
                                                <form
                                                    action="{{ !$student->deleted_at ? route('clerk.manage-student.destroy', $student->id) : route('clerk.manage-student.restore', $student->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8">
                                                ...
                                                <form
                                                    action="{{ !$student->email_verified_at ? route('clerk.manage-student.verify', $student->id) : route('clerk.manage-student.unverify', $student->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
